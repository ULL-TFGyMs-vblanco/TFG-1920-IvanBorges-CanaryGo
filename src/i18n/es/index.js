export default {
  ...
  title1: 'NO MÁ.S EVENTOS OLVIDADOS',
  ...
  delete_verification: '¿Seguro que deseas realizar esta acción?',
  alert: 'Atención',
  location: 'Isla',
  ...
  comment_post: 'Publica un comentario',
  upload_label: 'Publicar',
  bold: 'Negrita',
  italic: 'Cursiva',
  underline: 'Subrayado',
